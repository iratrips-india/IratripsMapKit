...
using Iratrips.Mapkit.Razor;
using Microsoft.AspNetCore.Components;

namespace Iratrips.Mapkit;

public partial class TKCustomMap : IMapFunctions
{
    ...
    #region Platform Property Getter Setters
    private object _mapFunctions;
    private object _pins;
    private object _selectedPin;
    private object _pinSelectedCommand;
    private object _mapClickedCommand;
    private object _mapLongPressCommand;
    private object _pinDragEndCommand;
    private object _pinsReadyCommand;
    private object _isRegionChangeAnimated;
    private object _showTraffic;
    private object _polylinesProperty;
    private object _circlesProperty;
    private object _calloutClickedCommand;
    private object _polygonsProperty;
    private object _mapRegion;
    private object _routesProperty;
    private object _routeClickedCommand;
    private object _routeCalculationFinishedCommand;
    private object _routeCalculationFailedCommand;
    private object _tilesUrlOptions;
    private object _userLocationChangedCommand;
    private object _getCalloutView;
    private object _mapType;
    private object _isShowingUser;
    private object _hasScrollEnabled;
    private object _hasZoomEnabled;
    private object _mapReadyCommand;
    private object _cameraIdealCommand;
    private object _cameraMoveStartedCommand;
    ...
    public partial void SetValueFromPlatform(string propertyName, object value)
    {
        ...
        {
            _mapLongPressCommand = value;
        }
        else if (propertyName == nameof(PinDragEndCommand))
        {
            _pinDragEndCommand = value;
        }
        else if (propertyName == nameof(PinsReadyCommand))
        {
            _pinsReadyCommand = value;
        }
        ...
        {
            _polylinesProperty = value;
        }
        else if (propertyName == nameof(Circles))
        {
            _circlesProperty = value;
        }
        else if (propertyName == nameof(CalloutClickedCommand))
        {
            _calloutClickedCommand = value;
        }
        else if (propertyName == nameof(Polygons))
        {
            _polygonsProperty = value;
        }
        else if (propertyName == nameof(MapRegion))
        {
            _mapRegion = value;
        ...
        {
            _routesProperty = value;
        }
        else if (propertyName == nameof(RouteClickedCommand))
        {
            _routeClickedCommand = value;
        }
        else if (propertyName == nameof(RouteCalculationFinishedCommand))
        {
            _routeCalculationFinishedCommand = value;
        }
        else if (propertyName == nameof(RouteCalculationFailedCommand))
        {
            _routeCalculationFailedCommand = value;
        }
        else if (propertyName == nameof(TilesUrlOptions))
        {
            _tilesUrlOptions = value;
        }
        else if (propertyName == nameof(UserLocationChangedCommand))
        {
            _userLocationChangedCommand = value;
        }
        else if (propertyName == nameof(GetCalloutView))
        {
            _getCalloutView = value;
        }
        else if (propertyName == nameof(MapType))
        {
            _mapType = value;
        ...
        {
            _mapReadyCommand = value;
        }
        else if (propertyName == nameof(CameraIdealCommand))
        {
            _cameraIdealCommand = value;
        }
        else if (propertyName == nameof(CameraMoveStartedCommand))
        {
            _cameraMoveStartedCommand = value;
        }
    }
    #endregion
    ...
    /// <param name="sender">Event Sender</param>
    /// <param name="e">Event Arguments</param>
    void OnMarkerClick(TKMarker marker)
    {
        var item = _markers.SingleOrDefault(i => true == i.Value.MarkerId.Equals(marker.MarkerId));
        if (item.Key == null) return;

        _selectedMarker = marker;
        this.SelectedPin = item.Key;
    ...
    /// <param name="sender">Event Sender</param>
    /// <param name="e">Event Arguments</param>
    void OnMapLongClick(Position position)
    {
