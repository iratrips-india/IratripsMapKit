...
namespace Iratrips.MapKit.Droid
{
    ...
    /// </summary>
    public class IMCustomTileProvider : UrlTileProvider
    {
         readonly IMTileUrlOptions _options;
        /// <summary>
        /// Creates a new instance of <see cref="IMCustomTileProvider" />
        /// </summary>
        /// <param name="options">Options of the tiles</param>
        public IMCustomTileProvider(IMTileUrlOptions options) 
