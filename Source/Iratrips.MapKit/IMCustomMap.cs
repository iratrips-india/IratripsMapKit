...
namespace Iratrips.MapKit
{
    ...
    /// </summary>
    public class IMCustomMap : View, IMapFunctions
    {
        /// <summary>
        /// Event raised when a pin gets selected
        /// </summary>
        public event EventHandler<GenericEventArgs<IMCustomMapPin>> PinSelected;
        /// <summary>
        /// Event raised when a drag of a pin ended
        /// </summary>
        public event EventHandler<GenericEventArgs<IMCustomMapPin>> PinDragEnd;
        /// <summary>
        ...
        /// </summary>
        public event EventHandler<GenericEventArgs<IMRoute>> RouteClicked;
        /// <summary>
        /// Event raised when a route calculation finished successfully
        /// </summary>
        public event EventHandler<GenericEventArgs<IMRoute>> RouteCalculationFinished;
        /// <summary>
        ...
        /// </summary>
        public event EventHandler<GenericEventArgs<IMCustomMapPin>> CalloutClicked;
        /// <summary>
        ...
        public static readonly BindableProperty PinsProperty = BindableProperty.Create(
            nameof(Pins),
            typeof(IEnumerable<IMCustomMapPin>),
            typeof(IMCustomMap));
        /// <summary>
        ...
        public static readonly BindableProperty GetClusteredPinProperty = BindableProperty.Create(
            ...
            typeof(Func<string, IEnumerable<IMCustomMapPin>, IMCustomMapPin>),
            typeof(IMCustomMap));
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<IMCustomMapPin> Pins
        {
            get => (IEnumerable<IMCustomMapPin>)GetValue(PinsProperty);
            set => SetValue(PinsProperty, value);
        }
        /// <summary>
        /// Gets/Sets the currently selected pin on the map
        /// </summary>
        public IMCustomMapPin SelectedPin
        {
            get => (IMCustomMapPin)GetValue(SelectedPinProperty);
        ...
        /// </summary>
        public IEnumerable<IMPolyline> Polylines
        {
            get => (IEnumerable<IMPolyline>)GetValue(PolylinesProperty);
            set => SetValue(PolylinesProperty, value);
        }
        /// <summary>
        /// Gets/Sets the circles to display on the map
        /// </summary>
        public IEnumerable<IMCircle> Circles
        {
            get => (IEnumerable<IMCircle>)GetValue(CirclesProperty);
        ...
        /// </summary>
        public IEnumerable<IMPolygon> Polygons
        {
            get => (IEnumerable<IMPolygon>)GetValue(PolygonsProperty);
        ...
        /// </summary>
        public IEnumerable<IMRoute> Routes
        {
            get => (IEnumerable<IMRoute>)GetValue(RoutesProperty);
        ...
        {
            get => (Command<IMRoute>)GetValue(RouteClickedCommandProperty);
        ...
        /// </summary>
        public IMTileUrlOptions TilesUrlOptions
        {
            get => (IMTileUrlOptions)GetValue(TilesUrlOptionsProperty);
        ...
        /// </summary>
        public Func<string, IEnumerable<IMCustomMapPin>, IMCustomMapPin> GetClusteredPin
        {
            get => (Func<string, IEnumerable<IMCustomMapPin>, IMCustomMapPin>)GetValue(GetClusteredPinProperty);
        ...
        public IMCustomMap(MapSpan region)
        {
            MapRegion = region;
        }
        /// <summary>
        /// Creates a new instance of <see cref="IMCustomMap"/>
        /// </summary>
        ...
        public IMCustomMap(double initialLatitude, double initialLongitude, double distanceInKilometers) : 
        ...
        protected void OnPinSelected(IMCustomMapPin pin)
        {
            PinSelected?.Invoke(this, new GenericEventArgs<IMCustomMapPin>(pin));
        ...
        protected void OnPinDragEnd(IMCustomMapPin pin)
        {
            PinDragEnd?.Invoke(this, new GenericEventArgs<IMCustomMapPin>(pin));
        ...
        protected void OnRouteClicked(IMRoute route)
        {
            RouteClicked?.Invoke(this, new GenericEventArgs<IMRoute>(route));
        ...
        protected void OnRouteCalculationFinished(IMRoute route)
        {
            RouteCalculationFinished?.Invoke(this, new GenericEventArgs<IMRoute>(route));
        ...
        /// </summary>
        protected void OnCalloutClicked(IMCustomMapPin pin)
        {
            CalloutClicked?.Invoke(this, new GenericEventArgs<IMCustomMapPin>(pin));
        ...
        /// <inheritdoc/>
        void IMapFunctions.RaisePinSelected(IMCustomMapPin pin) => OnPinSelected(pin);
        /// <inheritdoc/>
        void IMapFunctions.RaisePinDragEnd(IMCustomMapPin pin) => OnPinDragEnd(pin);
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        void IMapFunctions.RaiseRouteClicked(IMRoute route) => OnRouteClicked(route);
        /// <inheritdoc/>
        void IMapFunctions.RaiseRouteCalculationFinished(IMRoute route) => OnRouteCalculationFinished(route);
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        void IMapFunctions.RaiseCalloutClicked(IMCustomMapPin pin) => OnCalloutClicked(pin);
        /// <inheritdoc/>
