namespace Iratrips.MapKit.Overlays
{
    ...
    public class IMTileUrlOptions 
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="IMTileUrlOptions"/>
        /// </summary>
        ...
        /// </param>
        public IMTileUrlOptions(string tilesUrl, int tileWidth, int tileHeight, int minZoomLevel, int maxZoomLevel)
        {
            TileWidth = tileWidth;
