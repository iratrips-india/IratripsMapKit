namespace Iratrips.MapKit.Overlays
{
    ...
    /// </summary>
    public class IMRoute : IMOverlay, IRouteFunctions
    {
        ...
        /// </summary>
        public IMRouteTravelMode TravelMode
        {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="IMRoute"/>
        /// </summary>
        public IMRoute()
        {
            LineWidth = 2.5f;
            Selectable = true;
            TravelMode = IMRouteTravelMode.Driving;
        }
        ///<inheritdoc/>
        ...
        ///<inheritdoc/>
        void IRouteFunctions.SetSteps(IMRouteStep[] steps)
        {
            Steps = steps;
        }
        ///<inheritdoc/>
