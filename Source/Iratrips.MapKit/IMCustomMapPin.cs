...
namespace Iratrips.MapKit
{
    ...
    /// A custom map pin
    /// </summary>
    public class IMCustomMapPin : IMBase
    {
         bool _isVisible;
         string _id;
         string _title;
        ...
        /// <summary>
        /// Gets the id of the <see cref="IMCustomMapPin"/>
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="IMCustomMapPin" />
        /// </summary>
        public IMCustomMapPin()
        {
            IsVisible = true;
        }
        ...
        /// </summary>
        /// <param name="obj">The <see cref="IMCustomMapPin"/> to compare</param>
        /// <returns>true of the ids match</returns>
        public override bool Equals(object obj)
        {
            var pin = obj as IMCustomMapPin;
