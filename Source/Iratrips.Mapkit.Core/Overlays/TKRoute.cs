...
namespace Iratrips.Mapkit.Overlays
{
    ...
    public class TKRoute : TKOverlay, IRouteFunctions
    {
        ...
        /// <summary>
        /// Gets/Sets if a route is selectable. If this is <value>false</value> <see cref="Iratrips.Mapkit.TKCustomMap.RouteClickedCommand"/> will not get raised for this route
        /// </summary>
