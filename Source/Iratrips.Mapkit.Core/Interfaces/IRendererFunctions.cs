...
namespace Iratrips.Mapkit.Interfaces
{
    ...
    public interface IRendererFunctions
    {
        ...
        void AnimateMarkerPosition(TKCustomMapPin pin, double speed, Position currentPosition, List<Position> nextPositions);
        ...
        IEnumerable<Position> ScreenLocationsToGeocoordinates(params TKPoint[] screenLocations);
