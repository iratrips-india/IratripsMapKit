...
namespace Iratrips.Mapkit
{
    ...
    public class TKCustomMapPin : TKBase
    {
        ...
        string _group;
        Position _position;
        TKImageSource _image;
        bool _isDraggable;
        TKColor _defaultPinColor;
        TKPoint _anchor = new TKPoint(0.5, 0.5);
        double _rotation;
        TKCallout _callout;
        ...
        /// </summary>
        public TKColor DefaultPinColor
        {
