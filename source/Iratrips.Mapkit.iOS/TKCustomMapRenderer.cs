...
namespace Iratrips.Mapkit.iOS
{
    ...
    public class TKCustomMapRenderer : ViewRenderer<TKCustomMap, MKMapView>, IRendererFunctions, IUIGestureRecognizerDelegate
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<TKCustomMap> e)
        {
            ...
            if (e.OldElement != null && Map != null)
            {
                ...
                Map.RegionWillChange -= Map_RegionWillChange;
        ...
        private void Map_RegionWillChange(object sender, MKMapViewChangeEventArgs e)
        {
        ...
        public virtual MKAnnotationView GetViewForAnnotation(MKMapView mapView, IMKAnnotation annotation)
        {
            ...
            else
            {
                ...
                annotationView.CanShowCallout = customAnnotation.CustomPin.Callout != null;
                if (customAnnotation.CustomPin.Callout != null && customAnnotation.CustomPin.Callout.HasCustomView)
                {
                    if (FormsMap.GetCalloutView != null)
                    {
                        ...
                        var sizeRequest = renderer.GetDesiredSize(UIScreen.MainScreen.Bounds.Width - 100, Double.MaxValue);
                        nativeView.Frame = new CGRect(0, 0, 200, 66);
                        annotationView.DetailCalloutAccessoryView = nativeView;
                    }
                }
        ...
        void AddRoute(TKRoute route)
        {
            ...
            directions.CalculateDirections((r, e) =>
            {
                ...
                {
                    var routeCalculationError = new RouteCalculationError(route, e.ToString());
        ...
        {
            if ((e.PropertyName == nameof(TKCustomMapPin.Position) && _isDragging))
                return;
            ...
            switch (e.PropertyName)
            {
                ...
                case nameof(TKCustomMapPin.Callout):
                    annotationView.CanShowCallout = formsPin.Callout != null;
